...
import { cn, getCategoryIcon, getCategoryColor, calculateFinancialSummary } from "@/lib/utils";
import Head from "next/head";

// Helper function to get/set goals from localStorage
                              ...
                              <div key={index} className="flex items-center justify-between">
                                <div className="flex items-center">
                                  <div className="w-8 h-8 rounded-full flex items-center justify-center mr-2" 
                                    ...
                                    <div className="text-sm" style={{ color: getCategoryColor(category) }}>
